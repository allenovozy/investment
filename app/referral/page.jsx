...
export default function ReferralPage() {
  ...
  useEffect(() => {
    ...
    const fetchUser = async () => {
      const res = await fetch("https://faitcurrency.online/server/Api/get_user.php", {
        method: "GET",
        credentials: "include",
      })
    ...
    const fetchStats = async () => {
      const res = await fetch("https://faitcurrency.online/server/Api/get_referrals_stats.php", {
        method: "GET",
        credentials: "include",
      })
      const data = await res.json()
