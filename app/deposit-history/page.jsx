  ...
  useEffect(() => {
    const fetchUserAndDeposits = async () => {
      ...
      try {
        ...
        const resUser = await fetch("http://192.168.1.150/server/Api/get_user.php", {
          credentials: "include"
        })
        ...
        const resDeposits = await fetch(`http://192.168.1.150/server/Api/get_deposits.php?page=${page}`, {
          credentials: "include"
        })
