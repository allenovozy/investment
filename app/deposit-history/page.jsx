  ...
  useEffect(() => {
    const fetchUserAndDeposits = async () => {
      ...
      try {
        ...
        const resUser = await fetch("https://faitcurrency.online/server/Api/get_user.php", {
          credentials: "include"
        })
        ...
        const resDeposits = await fetch(`https://faitcurrency.online/server/Api/get_deposits.php?page=${page}`, {
          credentials: "include"
        })
