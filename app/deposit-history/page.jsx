  ...
  useEffect(() => {
    const fetchUserAndDeposits = async () => {
      ...
      try {
        ...
        const resUser = await fetch("http://185.27.134.59/server/Api/get_user.php", {
          credentials: "include"
        })
        ...
        const resDeposits = await fetch(`http://185.27.134.59/server/Api/get_deposits.php?page=${page}`, {
          credentials: "include"
        })
