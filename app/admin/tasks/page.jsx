...
const Tasks = () => {
  ...
  const fetchTasks = async () => {
    try {
      const res = await fetch("http://192.168.1.150/server/Api/Admin/tasks/list.php", {
        credentials: "include",
      })
  ...
  const handleSave = async (e) => {
    ...
    try {
      const res = await fetch(`http://192.168.1.150/server/Api/Admin/tasks/${url}`, {
        method: "POST",
        credentials: "include",
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch("http://192.168.1.150/server/Api/Admin/tasks/delete.php", {
        method: "POST",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
